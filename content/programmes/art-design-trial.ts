...
export const ART_TRIAL_SESSION_5_8: TrialSession = {
  ...
  segments: [
    ...
    MAGNA_TILES_SEGMENT,
    {
      ...
      howToPlay:
        "a3 paper in front of each child. medium trays ready — children can choose what they want to make their art with: poster paints + brushes · colour pencils · brush pens. teacher lays out the options so each child can see and reach them. \"today you pick your medium too — colour pencils, brush pens, or paints. whichever feels right for the donut you're going to make.\" \"today we each make our own donut. just the donut — big, on the page, your colours.\" \"is it chocolate? pink icing? rainbow sprinkles? a bite taken out of it? that's your choice — it's your donut.\" teacher steps all the way back. children work. after 15 minutes — two or three children share by holding up their artwork. teacher asks each one: \"what kind of donut did you make? why those colours? why that medium? this is going home with you today — where are you going to put it?\" children say: fridge, bedroom wall, give it to someone. teacher takes masking tape, folds it into a loop sticky side out, presses it to the back of one piece of artwork, and sticks it briefly to the nearest wall. \"four loops of masking tape on the back — one for each corner — and it goes up on any wall without damaging it. your artwork deserves a wall. that's how you put it up.\" all artwork goes home.",
      materials: [
  ...
  segments: [
    ...
    SHAPE_FUSION_SEGMENT,
    {
      ...
      setupLine:
        "this is the part of every oh. art session i look forward to most. it's called artiverse — your universe of creation. every session this is the time where you make something completely yours. and this artwork goes home with you today. not next week. today.",
      howToPlay:
        "animal cue cards face-down in a fan. a3 paper in front of each child. medium trays ready — children can choose what they want to make their art with: oil pastels · colour pencils · brush pens · watercolour set + brushes + water pot. teacher lays out the options so each child can see and reach them. \"today you pick your medium too — whichever feels right for what you're going to make.\" \"first, paint your donut — big, on the page, your colours. icing, sprinkles, a bite taken out — your choice.\" children make their donut. \"now pick one animal card. don't show anyone yet.\" children pick secretly. \"your job: add the animal who wants to eat your donut. maybe it's sneaking up on it. maybe it's enormous next to a tiny donut. maybe the donut is bigger than the animal. that's your story — same page, donut and animal together.\" teacher steps all the way back. children work. after 15 minutes — two or three children share by holding up their artwork. teacher asks each one: \"what did you make? why that animal? why that medium? this is going home with you today — where are you going to put it?\" children say: fridge, bedroom wall, give it to someone. teacher takes masking tape, folds it into a loop sticky side out, presses it to the back of one piece of artwork, and sticks it briefly to the nearest wall. \"four loops of masking tape on the back — one for each corner — and it goes up on any wall without damaging it. your artwork deserves a wall. that's how you put it up.\" all artwork goes home.",
      materials: [
        "Donut reference card",
        "Animal Cue Cards",
