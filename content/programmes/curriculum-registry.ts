...
// Registry of every programme surfaced to teachers — powers the
// homepage grid and the library page. Ordered by category
// (art → language / speaking → robotics) then age (youngest → oldest).
